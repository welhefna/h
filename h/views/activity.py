...
class GroupSearchController(SearchController):
    ...
    def _show_join_page(self):
        """
        Decide whether to show a page which will prompt the user to join.

        :returns True if the user has permission to join or they are not logged in
        and False otherwise.
        """
    ...
    def _check_access_permissions(self):
        """
        Check the read permission policy and if necessary redirect to the join page.
